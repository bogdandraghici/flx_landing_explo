      ...
      <section className="section roi-method" id="how-calculated">
        <div className="shell">
          ...
          <ol className="roi-chain">
            <li className="roi-chain__step">
              <div className="roi-cell-rv rv" style={{ '--i': 0 }}>
            ...
            <li className="roi-chain__step">
              <div className="roi-cell-rv rv" style={{ '--i': 1 }}>
            ...
            <li className="roi-chain__step">
              <div className="roi-cell-rv rv" style={{ '--i': 2 }}>
            ...
            <li className="roi-chain__step">
              <div className="roi-cell-rv rv" style={{ '--i': 3 }}>
