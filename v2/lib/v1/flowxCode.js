/* FlowX Code page interactions, ported from v1 src/flowxCode.js.
   `initChrome()` runs in the layout <Chrome>; this exports only the
   page-specific behaviour (hero CLI typing + CTA static field). */
import { createStaticField } from './orderField.js';

export function initFlowxCode() {
  /* ================= hero cli typing ================= */
